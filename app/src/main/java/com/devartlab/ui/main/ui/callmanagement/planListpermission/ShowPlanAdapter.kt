...
class ShowPlanAdapter(context: Context) : RecyclerView.Adapter<ShowPlanAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_item_mobile, parent, false)
