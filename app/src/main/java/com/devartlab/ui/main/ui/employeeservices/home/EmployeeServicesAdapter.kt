...
class EmployeeServicesAdapter(context: Context, private val myData: List<CardModel>, private val onHomeItemClick: OnHomeItemClick) : RecyclerView.Adapter<EmployeeServicesAdapter.MyViewHolder>() {
