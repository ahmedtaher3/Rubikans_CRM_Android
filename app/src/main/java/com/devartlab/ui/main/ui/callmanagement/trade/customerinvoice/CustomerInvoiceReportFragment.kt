...
class CustomerInvoiceReportFragment : BaseFragment<EmployeeInvoiceReportFragmentBinding>(), ChooseEmployeeInterFace {
    private lateinit var viewModel: TradeReportsViewModel
    private lateinit var binding: EmployeeInvoiceReportFragmentBinding
    private lateinit var adapter: CustomerInvoiceReportAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = CustomerInvoiceReportAdapter(baseActivity, ArrayList())
    ...
    private fun setObservers() {
        viewModel.responseLiveDashboard.observe(viewLifecycleOwner, Observer {
            System.out.println(it.toString())
                    ...
                    binding.customersPaied.text = customerInvoiceDashboard[0].paiedInvoiceCustomer.toString()

                    binding.allReminder.text = customerInvoiceDashboard[0].totalReminder.toString()
                    binding.invoiceReminder.text = customerInvoiceDashboard[0].reminderInvoiceNumber.toString()
