...
class StartPointFilterAdapter(private val context: Context, private var myData: ArrayList<StartPointReportTitle>, private val onTitleSelect: OnTitleSelect) : RecyclerView.Adapter<StartPointFilterAdapter.ViewHolder>() {
