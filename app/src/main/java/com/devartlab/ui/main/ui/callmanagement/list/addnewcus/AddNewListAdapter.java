...
public class AddNewListAdapter extends RecyclerView.Adapter<AddNewListAdapter.MyViewHolder> {
   ...
   public interface AddToList
    {
        void addToList(CustomerList customerList);
    }


    public AddNewListAdapter(Context context , AddToList addToList , DataManager dataManager) {
    ...
    @Override
    public AddNewListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AddNewListAdapter.MyViewHolder(itemView);
    }
