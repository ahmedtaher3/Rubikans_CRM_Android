package com.devartlab.ui.main.ui.callmanagement.trade.printer.printerControl;
...
//                    strOption += EscapeSequence.getString(25);
            ...
            posPrinter.printNormal(POSPrinterConst.PTR_S_JOURNAL, strOption + data);
        } catch (JposException e) {
...
//    }
    ...
    public void directIOOccurred(DirectIOEvent directIOEvent) {
        OrderPrintActivity.Companion.showMsg(new String((byte[]) directIOEvent.getObject()) + "\n");
    }

    @Override
    public void errorOccurred(ErrorEvent errorEvent) {
        OrderPrintActivity.Companion.showMsg("Error : " + errorEvent);
    }

    @Override
    public void outputCompleteOccurred(OutputCompleteEvent outputCompleteEvent) {
        OrderPrintActivity.Companion.showMsg("outputComplete : " + outputCompleteEvent.getOutputID());
    }

    @Override
    public void statusUpdateOccurred(StatusUpdateEvent statusUpdateEvent) {
        OrderPrintActivity.Companion.showMsg(getSUEMessage(statusUpdateEvent.getStatus()));
    }
