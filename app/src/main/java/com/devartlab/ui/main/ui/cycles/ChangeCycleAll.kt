...
import com.devartlab.ui.main.ui.callmanagement.plan.cycles.CyclesAdapterAll
...
class ChangeCycleAll(context: Context, private var changeCycleInterface: ChangeCycleInterface, private var dataManager: DataManager, private var accId: Int) : Dialog(context), CyclesAdapter.CycleInterface {

    private var param1: String? = null
    private var param2: String? = null
    var adapter: CyclesAdapterAll? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = CyclesAdapterAll(context, this, dataManager)
