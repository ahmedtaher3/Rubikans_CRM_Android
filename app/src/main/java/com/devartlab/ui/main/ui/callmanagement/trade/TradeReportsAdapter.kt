...
class TradeReportsAdapter(context: Context, private val myData: List<CardModel>, private val onHomeItemClick: OnHomeItemClick) : RecyclerView.Adapter<TradeReportsAdapter.MyViewHolder>() {
