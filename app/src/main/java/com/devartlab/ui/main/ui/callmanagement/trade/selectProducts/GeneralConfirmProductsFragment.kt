...
class GeneralConfirmProductsFragment : BaseFragment<FragmentConfirmProductsBinding>(), GeneralProductsAdapter.OnItemSelect {

    lateinit var binding: FragmentConfirmProductsBinding
    lateinit var viewModel: TradeViewModel
    lateinit var adapter: GeneralConfirmProductsAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = GeneralConfirmProductsAdapter(baseActivity, ArrayList() , viewModel.dataManager?.offlineMood)
