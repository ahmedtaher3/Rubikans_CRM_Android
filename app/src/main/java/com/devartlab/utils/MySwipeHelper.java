...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private GestureDetector.SimpleOnGestureListener simpleOnGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            for (MyButton myBtn : buttonList) {

                if (myBtn.onClick(e.getX(), e.getY()))
                    break;
            }
            return true;
        }
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            RecyclerView.ViewHolder viewHolder = recyclerView.findViewHolderForAdapterPosition(swipePosition);
            View swipeItem = viewHolder.itemView;
            Rect rect = new Rect();
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            if (dX < 0) {
                ...
                if (!buttonBuffer.containsKey(pos)) {
                    instaintMyButton(viewHolder, buffer);
    ...
    private void drawButtons(Canvas c, View itemView, List<MyButton> buffer, int pos, float translationX) {

        float right = itemView.getRight();
        float dButtonWidth = -1 * translationX / buffer.size();

        for (MyButton myButton : buffer)
        {
    ...
    public abstract void instaintMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer);
